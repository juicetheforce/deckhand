...
console.log('the mapping');
{
  const rows = [
    ...
    [{ type: 'app', app: 'org.gimp.GIMP.desktop' }, {}, 'app-launch'],
    [{ type: 'app' }, {}, 'app-launch-unset'],
    [{ type: 'app', app: '' }, {}, 'app-launch-unset'],
    ...
    [{ type: 'audio.cycle', devices: [] }, {}, 'output-cycle'],
    [{ type: 'audio.source', node: 'n' }, {}, 'input-select'],
    [{ type: 'audio.cycleSource', devices: [] }, {}, 'input-cycle'],
